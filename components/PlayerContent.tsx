  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 h-full">
      ...
      <div className='hidden h-full md:flex justify-center items-center w-full max-w-[720px] gap-x-6'>
        <AiFillStepBackward size={30} className='text-neutral-400 hover:text-white transition cursor-pointer'
          onClick={onPlayPrevious} />
        <div onClick={handlePlay} className='flex items-center justify-center h-10 w-10 rounded-full bg-white cursor-pointer p-1'>
          <Icon size={30} className='text-black' />
        </div>
        <AiFillStepForward size={30} className='text-neutral-400 hover:text-white transition cursor-pointer'
          onClick={onPlayNext} />
      </div>
